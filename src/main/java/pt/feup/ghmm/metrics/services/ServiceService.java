...
import pt.feup.ghmm.metrics.repositories.ServiceRepository;
...
public class ServiceService {
    ...
    public pt.feup.ghmm.metrics.models.Service findOrCreateByName(String name, String image) {
        ...
        pt.feup.ghmm.metrics.models.Service service = repository.findByName(name);
        if(service != null) return service;

        ServiceType serviceType = getServiceType(name, image);
        service = pt.feup.ghmm.metrics.models.Service.builder()
                    .name(name)
    ...
    public Set<pt.feup.ghmm.metrics.models.Service> updateType(Set<pt.feup.ghmm.metrics.models.Service> services) {
        for(pt.feup.ghmm.metrics.models.Service service: services){
